...
description: Validate SKILL.md files against the Agent Skills spec and Perplexity Computer requirements before upload. Checklist of BLOCKER/WARN/INFO checks covering YAML frontmatter, name and description constraints, packaging, allowed-tools, and trigger-accuracy eval prompts. Use when the user asks to check, validate, lint, review, or sanity-check a skill file, or asks whether a skill is ready to upload.
---
